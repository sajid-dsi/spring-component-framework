...
public class DependencyTest extends TestCase {
    ...
    public void testParseNameWithoutType() throws Exception {
        Dependency dependency = Dependency.parse("spring.component.artifact-1.0.0");
        assertEquals("spring.component", dependency.getGroupId());
    ...
    public void testParseNameWithDotJar() throws Exception {
        Dependency dependency = Dependency.parse("spring.component.artifact-1.0.0.jar");
        assertEquals("spring.component", dependency.getGroupId());
        assertEquals("artifact", dependency.getArtifactId());
        assertEquals("1.0.0", dependency.getVersion());
    ...
    public void testParseNameWithDotPom() throws Exception {
        Dependency dependency = Dependency.parse("spring.component.artifact-1.0.0.pom");
        assertEquals("spring.component", dependency.getGroupId());
        assertEquals("artifact", dependency.getArtifactId());
        assertEquals("1.0.0", dependency.getVersion());
    ...
    public void testParseNameWithClassifier() throws Exception {
        Dependency dependency = Dependency.parse("spring.component.artifact-1.0.0.RELEASE.pom");
        assertEquals("spring.component", dependency.getGroupId());
        assertEquals("artifact", dependency.getArtifactId());
        assertEquals("1.0.0", dependency.getVersion());
        assertEquals("pom", dependency.getType());
    ...
    public void testParseNameWithClassifierSeparatedBySlash() throws Exception {
        Dependency dependency = Dependency.parse("spring.component.artifact-1.0.0-RELEASE-Rc1.pom");
        assertEquals("spring.component", dependency.getGroupId());
        assertEquals("artifact", dependency.getArtifactId());
        assertEquals("1.0.0", dependency.getVersion());
        assertEquals("pom", dependency.getType());
